...
public class PresetConfiguredFeatures {
    ...
    private static Holder<PlacedFeature> makePatch(Block state, int count) {
        return Holder.direct(new PlacedFeature(Holder.direct(new ConfiguredFeature<>(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(state.defaultBlockState())))), ImmutableList.of(CountPlacement.of(count), RandomOffsetPlacement.ofTriangle(7, 3), BlockPredicateFilter.forPredicate(BlockPredicate.ONLY_IN_AIR_PREDICATE))));
    }
